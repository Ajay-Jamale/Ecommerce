...
//		List<HomeCategory> mainCerosal = allCategories.stream()
//				.filter(category -> category.getSection() == HomeCategorySection.MAIN_CEROSAL).collect(Collectors.toList());
//		
...
//		home.setMainCerosal(mainCerosal);
